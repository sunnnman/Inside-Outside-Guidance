...
modelName = 'Grid_pascal_5010_gaussian7_refine'
...
model_save_dir = './runs/Grid_pascal_5010_gaussian7_refine'
log_dir = './runs/Grid_pascal_5010_gaussian7_refine/log'
...
if resume_epoch == 0:
    ...
    net.load_state_dict(
        torch.load("/home/zhupengqi/Inside-Outside-Guidance-master/runs/Grid_refine_pascal_5010_gaussian7_sample_gridsguide/models/Grid_refine_pascal_5010_gaussian7_sample_gridsguide__best_.pth",
...
if resume_epoch != nEpochs:
    ...
    # voc_train = GrabCutDataset(dataset_path='/home/datasets/GrabCut/', transform=composed_transforms_tr_grids)
    ...
    trainloader = DataLoader(db_train, batch_size=p['trainBatch'], shuffle=False, num_workers=2)
