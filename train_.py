...
modelName = 'Grid_5010_guassian7_sample_step20'
...
model_save_dir = './runs/Grid_5010_guassian7_sample_step20'
log_dir = './runs/Grid_5010_guassian7_sample_step20/log'
...
if resume_epoch == 0:  # 这个是跑到一半如果中断什么的重新跑，net从mypath里加载的模型才是预训练模型
    ...
    net.load_state_dict(
        torch.load(
            "/home/zhupengqi/Inside-Outside-Guidance-master/runs/Grid_city_5010_guassian7_sample_finetuning/models/Grid_city_5010_guassian7_sample_finetuning_best_.pth",
            map_location=lambda storage, loc: storage))
