...
class mscmrDataset(data.Dataset):
    def __init__(self, dataset_path,
                 images_dir_name='section_image/',masks_dir_name = 'gt/' , json_dir='mscmr.json'
                ,transform = None,**kwargs):
        super(mscmrDataset, self).__init__(**kwargs)
    ...
    def __len__(self):
        return len(self.jsonData['image'])
